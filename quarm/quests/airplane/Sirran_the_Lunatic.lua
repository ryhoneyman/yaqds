...
function event_say(e)
	...
	if(e.message:findi("hail")) then
		if(qglobals[sirranName] == "1") then 		--island1
		...
		elseif(qglobals[sirranName] == "2") then 	--island2
		...
		elseif(qglobals[sirranName] == "3") then 	--island3
		...
		elseif(qglobals[sirranName] == "4") then 	--island4
		...
		elseif(qglobals[sirranName] == "5") then 	--island5
		...
		elseif(qglobals[sirranName] == "7") then 	--island7
	...
	elseif(e.message:findi("citanul eht narris, liah") and qglobals[sirranName] == "6") then 	--island6
		e.self:Say("Lortap llaw taerg eht fo lahsram, Narris lahsram ma I. Flesym ecudortni ot em wolla. Sgniteerg");
	elseif(e.message:findi("llaw eht htiw eno I ma") and qglobals[sirranName] == "6") then 		--island6
